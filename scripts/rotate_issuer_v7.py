"""Rotate the AEGIS Emergency Communications Issuer to v7."""
...
def get_new_password() -> str:
    """Prompt for and confirm the new issuer password."""

    while True:
        password = getpass.getpass(
            "Enter password for the NEW Emergency Communications Issuer v7: "
        )
        ...
        confirmation = getpass.getpass(
            "Confirm password for the NEW Emergency Communications Issuer v7: "
        )
...
def main() -> None:
    print("=" * 64)
    print(
        "AEGIS Emergency Communications Issuer v7 Rotation"
    )
    print("=" * 64)
    print()
    ...
    print()
    print(
        "Generating new Emergency Communications Issuer v7..."
    )
    ...
    print(
        "Historical issuer credentials were not modified."
    )
    print(
        "Issuer v7 is now the current development signing credential."
    )
