...
def get_new_password() -> str:
    ...
    while True:
        password = getpass.getpass(
            "Enter password for the NEW Emergency Communications Issuer v5: "
        )
        ...
        confirmation = getpass.getpass(
            "Confirm password for the NEW Emergency Communications Issuer v5: "
        )
...
def main() -> None:
    print("=" * 64)
    print(
        "AEGIS Emergency Communications Issuer v5 Rotation"
    )
    print("=" * 64)
    print()
    ...
    print()
    print(
        "Generating new Emergency Communications Issuer v5..."
    )
    ...
    print(
        "Use Issuer v5 for all new AEGIS content."
    )
