"""Create the AEGIS Emergency Communications Issuer v8."""
...
def private_pki_root() -> Path:
    """Return the local-only private PKI root."""
...
def get_new_password() -> str:
    """Prompt for and confirm the v8 issuer password."""

    while True:
        password = getpass.getpass(
            "Enter password for the NEW Emergency Communications Issuer v8: "
        )
        ...
        confirmation = getpass.getpass(
            "Confirm password for the NEW Emergency Communications Issuer v8: "
        )
...
def main() -> None:
    print("=" * 72)
    print(
        "AEGIS Emergency Communications Issuer v8"
    )
    print("=" * 72)
    print()
    ...
    print()
    print(
        "Generating new Emergency Communications Issuer v8..."
    )
    ...
    print(
        "Saving encrypted v8 issuer key..."
    )
    ...
    print("=" * 72)
    print(
        "Issuer v8 created successfully."
    )
    print("=" * 72)
    print()

    print(
        f"Serial:         {issuer_certificate.serial_number}"
    )
    ...
    print(
        f"Not before:     {issuer_certificate.not_valid_before_utc.isoformat()}"
    )

    print(
        f"Not after:      {issuer_certificate.not_valid_after_utc.isoformat()}"
    )
    ...
    print()
    print(
        "The v8 credential has NOT yet been registered in Neon."
    )
    print(
        "Run bootstrap_credentials_v8.py next."
    )
